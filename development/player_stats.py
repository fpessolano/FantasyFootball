# SCRATCH FILE: Player statistics management system
# Handles player stat dictionaries and DataFrame conversions
# Work in progress - transitioning from dict-based to DataFrame-based stats
# Not used in main application - experimental stats data structure
